...
```java
package org.recrypt.wallet.utils.CurrentNetParams

    public static NetworkParameters getNetParams() {
        return RecryptMainNetParams.get(); // or RecryptTestNetParams.get();
    }
...
- ``` 'com.github.designsters:android-fork-bitcoinj:1.+'```  – fork bitcoinj (with RECRYPT functionality)
...
The android fork bitcoinj library is a Java implementation of the Bitcoin protocol, which allows it to maintain a RECRYPT wallet and send/receive transactions without needing a local copy of Bitcoin Core. It comes with full documentation and some example apps showing how to use it<br/>
