...
import org.recrypt.wallet.ui.fragment.set_your_token_fragment.ConstructorAdapter;
...
public class ConstructorAdapterLight extends ConstructorAdapter {
    ...
    public InputViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new InputViewHolderLight(LayoutInflater.from(parent.getContext()).inflate(org.recrypt.wallet.R.layout.lyt_constructor_input_light, parent, false), listener);
    }
