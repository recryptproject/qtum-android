package org.recrypt.wallet.ui.fragment.wallet_fragment.dark;
...
import org.recrypt.wallet.utils.ResizeWidthAnimation;
...
public class WalletFragmentDark extends WalletFragment {
    ...
    public void updateBalance(String balance, String unconfirmedBalance) {
        try {
            balanceValue.setText(String.format("%s RECRYPT", balance));
            if (unconfirmedBalance != null) {
                ...
                uncomfirmedBalanceValue.setText(String.format("%s RECRYPT", unconfirmedBalance));
            } else {
                uncomfirmedBalanceValue.setVisibility(View.GONE);
                uncomfirmedBalanceTitle.setVisibility(View.GONE);
            }
