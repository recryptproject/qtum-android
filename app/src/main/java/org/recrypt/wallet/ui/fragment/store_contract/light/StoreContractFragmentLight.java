package org.recrypt.wallet.ui.fragment.store_contract.light;
...
public class StoreContractFragmentLight extends StoreContractFragment {
    ...
    protected int getLayout() {
        return org.recrypt.wallet.R.layout.lyt_store_contract_light;
    }
    ...
    @OnClick(org.recrypt.wallet.R.id.ibt_view_abi)
    ...
    public void setContractData(QstoreContract contract) {
        ...
        rvTags.setAdapter(new TagRecyclerViewAdapter(contract.tags, this, org.recrypt.wallet.R.layout.item_tag_light));
