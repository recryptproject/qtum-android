...
import org.recrypt.wallet.utils.SearchBar;
import org.recrypt.wallet.utils.SearchBarListener;
...
public abstract class SubscribeTokensFragment extends BaseFragment implements SubscribeTokensView, SearchBarListener {
    ...
    @BindView(org.recrypt.wallet.R.id.recycler_view)
    protected
    RecyclerView mRecyclerView;

    @BindView(org.recrypt.wallet.R.id.tv_currency_title)
    TextView mTextViewCurrencyTitle;

    @BindView(org.recrypt.wallet.R.id.search_bar)
    SearchBar searchBar;
    ...
    public void initializeViews() {
        ...
        mTextViewCurrencyTitle.setText(org.recrypt.wallet.R.string.chose_to_subscribe);
    ...
    class TokenHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(org.recrypt.wallet.R.id.iv_check_indicator_blue)
        ImageView mImageViewCheckIndicator;
        @BindView(org.recrypt.wallet.R.id.ll_single_item)
