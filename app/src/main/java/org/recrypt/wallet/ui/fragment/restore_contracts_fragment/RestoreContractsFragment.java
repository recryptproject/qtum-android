...
import org.recrypt.wallet.utils.FileUtils;
import org.recrypt.wallet.utils.FontCheckBox;
...
public abstract class RestoreContractsFragment extends BaseFragment implements RestoreContractsView {
    ...
    @BindView(org.recrypt.wallet.R.id.rl_back_up_file)
    protected
    FrameLayout mFrameLayoutBackUpFile;
    @BindView(org.recrypt.wallet.R.id.cb_restore_templates)
    FontCheckBox mCheckBoxRestoreTemplates;
    @BindView(org.recrypt.wallet.R.id.cb_restore_contracts)
    FontCheckBox mCheckBoxRestoreContracts;
    @BindView(org.recrypt.wallet.R.id.cb_restore_tokens)
    FontCheckBox mCheckBoxRestoreTokens;
    @BindView(org.recrypt.wallet.R.id.cb_restore_all)
    FontCheckBox mCheckBoxRestoreAll;

    @BindView(org.recrypt.wallet.R.id.tv_select_back_up)
    protected
    FontTextView mTextViewFileName;
    @BindView(org.recrypt.wallet.R.id.tv_file_size)
    protected
    FontTextView mTextViewFileSize;
    @BindView(org.recrypt.wallet.R.id.iv_restore_icon)
    protected
    ImageView mImageViewRestoreIcon;

    @OnClick({org.recrypt.wallet.R.id.rl_back_up_file, org.recrypt.wallet.R.id.cb_restore_templates, org.recrypt.wallet.R.id.cb_restore_contracts, org.recrypt.wallet.R.id.cb_restore_tokens, org.recrypt.wallet.R.id.cb_restore_all, org.recrypt.wallet.R.id.iv_restore_icon, org.recrypt.wallet.R.id.ibt_back, org.recrypt.wallet.R.id.bt_restore})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.recrypt.wallet.R.id.rl_back_up_file:
                ...
                break;
            case org.recrypt.wallet.R.id.iv_restore_icon:
                ...
                break;
            case org.recrypt.wallet.R.id.cb_restore_templates:
                ...
                break;
            case org.recrypt.wallet.R.id.cb_restore_contracts:
                ...
                break;
            case org.recrypt.wallet.R.id.cb_restore_tokens:
                ...
                break;
            case org.recrypt.wallet.R.id.cb_restore_all:
            ...
            case org.recrypt.wallet.R.id.ibt_back:
                ...
                break;
            case org.recrypt.wallet.R.id.bt_restore:
                if (mCheckBoxRestoreAll.isChecked()) {
