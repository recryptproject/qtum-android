...
import org.recrypt.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String recryptAddressKey = "recryptAddressKey";
    ...
    @Override
    public void setRecryptAddress(String address) {
        if (!TextUtils.isEmpty(address)) {
