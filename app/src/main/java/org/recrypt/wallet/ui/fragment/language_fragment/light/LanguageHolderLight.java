...
import org.recrypt.wallet.ui.fragment.language_fragment.LanguageHolder;
...
public class LanguageHolderLight extends LanguageHolder {
    ...
    public void bindLanguage(Pair<String, String> language) {
        if (language.first.equals(RecryptSharedPreference.getInstance().getLanguage(mTextViewLanguage.getContext()))) {
