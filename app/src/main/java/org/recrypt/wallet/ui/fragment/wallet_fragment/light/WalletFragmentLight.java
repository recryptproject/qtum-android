...
public class WalletFragmentLight extends WalletFragment {
    ...
    public void updateBalance(String balance, String unconfirmedBalance) {
        try {
            balanceValue.setText(getSpannedBalance(String.format("%s RECRYPT", balance)));
            placeHolderBalance.setText(getSpannedBalance(String.format("%s RECRYPT", balance)));
            if (unconfirmedBalance != null) {
                ...
                uncomfirmedBalanceValue.setText(getSpannedBalance(String.format("%s RECRYPT", unconfirmedBalance)));
                placeHolderBalanceNotConfirmed.setText(getSpannedBalance(String.format("%s RECRYPT", unconfirmedBalance)));
            } else {
