...
public abstract class TouchIDPreferenceFragment extends BaseFragment implements TouchIDPreferenceView {
    ...
    @OnClick({org.recrypt.wallet.R.id.bt_enable_touch_id, org.recrypt.wallet.R.id.bt_not_now})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.recrypt.wallet.R.id.bt_enable_touch_id:
                getPresenter().onEnableTouchIdClick();
            case org.recrypt.wallet.R.id.bt_not_now:
                if (mIsImporting) {
