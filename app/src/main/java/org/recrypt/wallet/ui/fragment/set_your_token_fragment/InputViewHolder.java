...
import org.recrypt.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.recrypt.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.recrypt.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.recrypt.wallet.R.id.checkbox)
    ...
    public InputViewHolder(View itemView, OnValidateParamsListener listener) {
        ...
        tilParam.setTypeface(FontManager.getInstance().getFont(tilParam.getContext().getString(org.recrypt.wallet.R.string.simplonMonoRegular)));
        etParam.setTypeface(FontManager.getInstance().getFont(etParam.getContext().getString(org.recrypt.wallet.R.string.simplonMonoRegular)));
