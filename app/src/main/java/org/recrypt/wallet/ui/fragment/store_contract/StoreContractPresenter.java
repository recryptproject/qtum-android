...
import org.recrypt.wallet.model.gson.qstore.QstoreBuyResponse;
...
import org.recrypt.wallet.ui.fragment.send_fragment.SendInteractorImpl;
...
import static org.recrypt.wallet.datastorage.FileStorageManager.HUMANSTANDARDTOKENUUID;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_recrypt_address));
                    return;
                }
