package org.recrypt.wallet.ui.fragment.token_fragment.dark;
...
import org.recrypt.wallet.ui.fragment.token_fragment.TokenHistoryAdapter;
import org.recrypt.wallet.ui.fragment.token_fragment.TokenHistoryClickListener;
...
import org.recrypt.wallet.ui.fragment.wallet_fragment.dark.TransactionHolderDark;
...
public class TokenHistoryAdapterDark extends TokenHistoryAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_TRANSACTION) {
            ...
            View view = layoutInflater.inflate(org.recrypt.wallet.R.layout.item_transaction, parent, false);
            return new TokenHistoryHolderDark(view, listener, decimalUnits);
        } else {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(org.recrypt.wallet.R.layout.item_progress_bar, parent, false);
