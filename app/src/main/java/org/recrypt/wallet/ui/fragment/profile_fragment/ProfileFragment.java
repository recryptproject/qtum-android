...
import org.recrypt.wallet.ui.fragment.about_fragment.AboutFragment;
...
import org.recrypt.wallet.ui.fragment.subscribe_tokens_fragment.SubscribeTokensFragment;
...
import static org.recrypt.wallet.ui.fragment.pin_fragment.PinAction.AUTHENTICATION_FOR_PASSPHRASE;
import static org.recrypt.wallet.ui.fragment.pin_fragment.PinAction.CHANGING;
...
public abstract class ProfileFragment extends BaseFragment implements ProfileView, OnSettingClickListener {
    ...
    @BindView(org.recrypt.wallet.R.id.pref_list)
    ...
    public void onSettingClick(int key) {
        ...
        switch (key) {
            ...
            case org.recrypt.wallet.R.string.log_out:
                ...
                break;
            case org.recrypt.wallet.R.string.switch_theme:
    ...
    public void onSwitchChange(int key, boolean isChecked) {
        switch (key) {
            case org.recrypt.wallet.R.string.touch_id:
