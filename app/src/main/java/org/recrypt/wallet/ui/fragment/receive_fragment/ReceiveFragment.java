...
import org.recrypt.wallet.ui.fragment.wallet_fragment.WalletFragment;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView {
    ...
    @BindView(org.recrypt.wallet.R.id.iv_qr_code)
    ...
    @BindView(org.recrypt.wallet.R.id.tv_single_string)
    TextView mTextViewAddress;
    @BindView(org.recrypt.wallet.R.id.bt_copy_wallet_address)
    Button mButtonCopyWalletAddress;
    @BindView(org.recrypt.wallet.R.id.bt_choose_another_address)
    Button mButtonChooseAnotherAddress;
    @BindView(org.recrypt.wallet.R.id.ibt_back)
    ImageButton mImageButtonBack;
    @BindView(org.recrypt.wallet.R.id.rl_receive)
    RelativeLayout mRelativeLayoutBase;
    @BindView(org.recrypt.wallet.R.id.cl_receive)
    protected
    CoordinatorLayout mCoordinatorLayout;

    @BindView(org.recrypt.wallet.R.id.qr_progress_bar)
    ...
    @OnClick(org.recrypt.wallet.R.id.iv_qr_code)
    ...
    @OnClick(org.recrypt.wallet.R.id.bt_share)
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "RECRYPT QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "Recrypt QR-Code"));
        }
    }
    ...
    @OnClick({org.recrypt.wallet.R.id.bt_copy_wallet_address, org.recrypt.wallet.R.id.bt_choose_another_address, org.recrypt.wallet.R.id.ibt_back})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.recrypt.wallet.R.id.bt_copy_wallet_address:
                onCopyWalletAddressClick();
                break;
            case org.recrypt.wallet.R.id.bt_choose_another_address:
    ...
    public void initializeViews() {
        ...
        setQrColors(ContextCompat.getColor(getContext(), org.recrypt.wallet.R.color.colorPrimary), mCoordinatorLayout.getDrawingCacheBackgroundColor());
        ...
        mTextInputEditTextAmount.setTypeface(FontManager.getInstance().getFont(getString(org.recrypt.wallet.R.string.simplonMonoRegular)));
        mTextInputLayoutAmount.setTypeface(FontManager.getInstance().getFont(getString(org.recrypt.wallet.R.string.simplonMonoRegular)));
    ...
    public void openFragmentForResult(Fragment fragment) {
        ...
        getFragmentManager()
                ...
                .add(org.recrypt.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
                .addToBackStack(null)
                .commit();
    }
    ...
    public void showToast() {
        Toast.makeText(getContext(), org.recrypt.wallet.R.string.copied, Toast.LENGTH_SHORT).show();
    }
