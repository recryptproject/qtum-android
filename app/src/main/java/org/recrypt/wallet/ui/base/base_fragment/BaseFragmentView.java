...
import org.recrypt.wallet.ui.base.base_activity.BaseContextView;
...
public interface BaseFragmentView extends BaseContextView {
    ...
    void setAlertDialog(@StringRes int titleResId, String message, @StringRes int buttonTextResId, BaseFragment.PopUpType type);
