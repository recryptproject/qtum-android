...
import org.recrypt.wallet.ui.fragment.token_cash_management_fragment.AddressesListFragmentToken;
import org.recrypt.wallet.ui.fragment.token_cash_management_fragment.TokenAddressesAdapter;
...
public class AddressesListFragmentTokenDark extends AddressesListFragmentToken {
    ...
    protected int getLayout() {
        return org.recrypt.wallet.R.layout.fragment_address_list;
    }

    @Override
    public void updateAddressList(List<DeterministicKeyWithTokenBalance> deterministicKeyWithBalance, String currency) {
        if (mRecyclerView != null) {
            adapter = new TokenAddressesAdapter(deterministicKeyWithBalance, org.recrypt.wallet.R.layout.item_address, this, currency, getPresenter().getDecimalUnits());
    ...
    protected void showTransferDialogFragment(final DeterministicKeyWithTokenBalance keyWithBalanceTo, List<DeterministicKeyWithTokenBalance> keyWithBalanceList, int decimalUnits) {
        View view = LayoutInflater.from(getContext()).inflate(org.recrypt.wallet.R.layout.dialog_transfer_balance_fragment, null);
        final TextInputEditText mEditTextAmount = (TextInputEditText) view.findViewById(org.recrypt.wallet.R.id.et_amount);
        final Spinner spinner = (Spinner) view.findViewById(org.recrypt.wallet.R.id.spinner_transfer);
        FontTextView mEditTextAddressTo = (FontTextView) view.findViewById(org.recrypt.wallet.R.id.tv_address_to);
        ...
        view.findViewById(org.recrypt.wallet.R.id.bt_back).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        view.findViewById(org.recrypt.wallet.R.id.bt_transfer).setOnClickListener(new View.OnClickListener() {
            @Override
