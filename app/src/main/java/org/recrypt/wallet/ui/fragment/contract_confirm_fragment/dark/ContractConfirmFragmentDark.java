...
import org.recrypt.wallet.ui.fragment.contract_confirm_fragment.ContractConfirmFragment;
...
public class ContractConfirmFragmentDark extends ContractConfirmFragment {
    ...
    public final int LAYOUT = org.recrypt.wallet.R.layout.lyt_contract_confirm;

    @OnClick(org.recrypt.wallet.R.id.cancel)
