...
public class RecryptSettingSharedPreference {

    private final String RECRYPT_SETTING = "recrypt_setting";
    ...
    public void setShowContractsDeleteUnsubscribeWizard(Context context, boolean isShow) {
        SharedPreferences mSharedPreferences = context.getSharedPreferences(RECRYPT_SETTING, Context.MODE_PRIVATE);
    ...
    public boolean getShowContractsDeleteUnsubscribeWizard(Context context) {
        return context.getSharedPreferences(RECRYPT_SETTING, Context.MODE_PRIVATE).getBoolean(SHOW_CONTRACTS_DELETE_UNSUBSCRIBE_WIZARD, true);
    }
    ...
    public int getCodeVersion(Context context){
        return context.getSharedPreferences(RECRYPT_SETTING, Context.MODE_PRIVATE).getInt(MIGRATION_VERSION_STRING, 0);
    }
    ...
    public String getFeePerKb(Context context) {
        return context.getSharedPreferences(RECRYPT_SETTING, Context.MODE_PRIVATE).getString(FEE_PER_KB, "0.006");
    }
}
