package org.recrypt.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    private final static String RECRYPT_PIN_ALIAS = "recrypt_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = RecryptSharedPreference.getInstance().getSeed(context);
