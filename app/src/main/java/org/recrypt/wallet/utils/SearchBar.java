...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.recrypt.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.recrypt.wallet.R.id.text);
        input = (EditText) findViewById(org.recrypt.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.recrypt.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.recrypt.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.recrypt.wallet.R.id.bt_clear_search);
