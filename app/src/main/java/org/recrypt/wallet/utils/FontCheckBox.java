...
public class FontCheckBox extends AppCompatCheckBox {
    ...
    public FontCheckBox(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, org.recrypt.wallet.R.styleable.FontCheckBox);

        if (ta != null) {
            String fontAsset = ta.getString(org.recrypt.wallet.R.styleable.FontCheckBox_checkBoxTypeface);
