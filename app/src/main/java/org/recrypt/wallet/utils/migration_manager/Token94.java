package org.recrypt.wallet.utils.migration_manager;
...
public class Token94 extends Contract94 {
    ...
    public Token94(String contractAddress, String templateUiid, Boolean hasBeenCreated, String date, String senderAddress, String contractName) {
