package org.recrypt.wallet.dataprovider.rest_api.recrypt;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;

import org.recrypt.wallet.model.gson.BlockChainInfo;
...
import org.recrypt.wallet.model.gson.token_history.TokenHistoryResponse;
...
public class RecryptService {

    private static RecryptService sRecryptService;
    private RecryptRestService mServiceApi;

    public static RecryptService newInstance() {
        if (sRecryptService == null) {
            sRecryptService = new RecryptService();
        }
        return sRecryptService;
    }

    private RecryptService() {
        try {
            ...
            mServiceApi = retrofit.create(RecryptRestService.class);
