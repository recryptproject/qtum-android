package org.recrypt.wallet.dataprovider.services.update_service;
...
import org.recrypt.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.recrypt.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.recrypt.wallet.utils.BoughtContractBuilder;

import org.recrypt.wallet.R;
import org.recrypt.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.recrypt.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.recrypt.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import static org.recrypt.wallet.WearListCallListenerService.ADDRESS;
import static org.recrypt.wallet.WearListCallListenerService.BALANCE;
import static org.recrypt.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.recrypt.wallet.WearListCallListenerService.ITEMS;
import static org.recrypt.wallet.WearListCallListenerService.UNC_BALANCE;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    private void onBalanceChange() {
        RecryptService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
                ...
                .subscribe(new Subscriber<HistoryResponse>() {
                    ...
                    public void onNext(HistoryResponse historyResponse) {
                        ...
                        sendData(s, balance.toString(), unconfirmedBalance.toString(), RecryptApplication.instance.getWearableMessagingProvider().getAddress());
                    }
                });
    }
